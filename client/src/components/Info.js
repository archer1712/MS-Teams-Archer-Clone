//It renders the right drawer on pressing the info buttons. It contains call link and other call info
...
function Info(props) {
  ...
  //Closes message on the bottom left that appears on copying link
  const handleClose = () => {
    setOpenBar(false);
  };
  ...
  return (
    <div className={classes.root}>
      ...
      <Tooltip title="Copy Meet Link">
        ...
        >
          <FileCopyIcon className={classes.mediaIcon} />
        </Button>
      </Tooltip>
      <Typography variant="body1" gutterBottom>
