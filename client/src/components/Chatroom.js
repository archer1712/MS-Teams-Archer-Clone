//It renders the chatbox before and after the video call
    ...
    <div className={classes.root}>
      <div className={classes.chatroom}>
        <div className={classes.msgList}>
          ...
          {emojiPickerOpen && (
            <Picker className={classes.emojiPicker} onSelect={addEmoji} />
          )}
        </div>
        <form
        ...
        >
          <div className={classes.inform}>
            <AppBar position="fixed" className={classes.appBar}>
              <Toolbar>
                <Button onClick={handleEmojiButton} className={classes.btn}>
                  <EmojiEmotionsIcon className={classes.iconBtn} />
                </Button>
                <TextField
                ...
                <Button className={classes.btn} type="submit">
                  <SendIcon className={classes.iconBtn}></SendIcon>
                </Button>
                <Button
                  variant="contained"
                  className={classes.joinCall}
